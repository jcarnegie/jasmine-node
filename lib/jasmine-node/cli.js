...
var helperCollection = require('./spec-collection').create();
...
while(args.length) {
  ...
  switch(arg)
  {
    ...
    case '--runWithRequireJs':
        useRequireJs = true;
        break;
    case '--requireJsBaseUrl':
        requireJsBaseUrl = args.shift();
        break;
    case '--nohelpers':
        useHelpers = false;
        break;
...
function help(){
  ...
  , '  --requireJsBaseUrl - base url / directory to load requirejs modules from'
