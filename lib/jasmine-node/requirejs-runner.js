exports.executeJsRunner = function(specCollection, done, jasmineEnv, requireJsBaseUrl) {
  var specs,
  ...
  specCollection.getSpecs().forEach(function(s){
    ...
    var baseUrl = (requireJsBaseUrl) ? requireJsBaseUrl : buildRelativeDirName(dir);
    wrappedScript = template.replace(/#REPLACE URL#/, baseUrl)
